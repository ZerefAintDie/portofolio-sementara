...
const SOCIAL = [
  {
    name: 'GitHub', href: 'https://github.com/ZerefAintDie', color: '#fff',
  ...
  {
    name: 'TikTok', href: 'https://www.tiktok.com/@althafino_', color: '#ff0050',
  ...
  {
    name: 'Instagram', href: 'https://www.instagram.com/althafino_/', color: '#E1306C',
    ...
    <section ref={ref} id="contact" className="py-32 px-4 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={isInView ? { opacity: 1, y: 0 } : {}} transition={{ duration: 0.6 }}>
          ...
          <motion.a href="mailto:malthafino36@gmail.com"
    ...
    <footer className="py-8 px-4" style={{ borderTop: '1px solid rgba(255,255,255,0.04)' }}>
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-3">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-display font-semibold gradient-text">Muhammad Althafino</span>
        </div>
        <p className="text-xs font-mono" style={{ color: '#333' }}>
          © {new Date().getFullYear()} Muhammad Althafino · Built with React, TypeScript & GSAP · All rights reserved
        </p>
